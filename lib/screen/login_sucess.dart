<<<<<<< HEAD:lib/Register/login_sucess.dart
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushAndRemoveUntil(
                  ...
                  MaterialPageRoute(builder: (context) => DashboardPage()),
                  (Route<dynamic> route) =>
                      false, // Bersihkan stack sehingga tidak ada rute sebelumnya
                );
              },
              child: Text("Back to home"),
            ),
...
>>>>>>> 8332ae40505e205f05b12c0ea138b291adffa3f9:lib/screen/login_sucess.dart
